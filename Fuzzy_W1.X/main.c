...
double Vxb=0.0,Vxm=0.0,VxA=0.0,Vyb=0.0,Vym=0.0,VyA=0.0,Wpb=0.0,Wpm=0.0,WpA=0.0;
float Rules[27];
float min_pert[27];
float Val_num[27];
float Num=0.0;
float Val_min_pert=0.0;
float OUT=0.0;
...
void main(void)
{
    ...
    OUT=Num*100.0/Val_min_pert;
    
    while(1)
    {
        UART1_Write4((signed int)OUT);
        /*
        UART1_Write4((signed int)Vx_);
        UART1_Write4((signed int)Vy_);
        UART1_Write4((signed int)Wp_);

        UART1_Write4((signed int)Vxb);
        UART1_Write4((signed int)Vxm);
        UART1_Write4((signed int)VxA);

        UART1_Write4((signed int)Vyb);
        UART1_Write4((signed int)Vym);
        UART1_Write4((signed int)VyA);

        UART1_Write4((signed int)Wpb);
        UART1_Write4((signed int)Wpm);
        UART1_Write4((signed int)WpA);
        UART1_Write4(10000);
        */
        __delay_ms(5000);
    }
